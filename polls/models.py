...
class Parent(models.Model):
    ...
    user_name = models.CharField(max_length=255, default='', verbose_name='Nom d’utilisateur')
    name = models.CharField(max_length=255, default='', verbose_name='Nom du Parent')
